# Generated by Django 3.2.15 on 2023-02-05 00:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downloaded_version', models.TextField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, null=True, upload_to='primary_storage/systemfiles/images/')),
                ('app_homepage_url', models.TextField(blank=True, max_length=100, null=True)),
                ('support_process_apps', models.TextField(blank=True, max_length=5000, null=True)),
                ('app_author', models.TextField(blank=True, max_length=100, null=True)),
                ('last_install', models.DateTimeField(blank=True, null=True)),
                ('downloaded_version', models.TextField(blank=True, max_length=100, null=True)),
                ('is_installed', models.BooleanField(default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow_tool', models.TextField(blank=True, default='None', max_length=100, null=True)),
